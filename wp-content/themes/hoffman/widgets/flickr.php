...
// Flickr widget for Hoffman WordPress theme

class hoffman_flickr extends WP_Widget {

	function hoffman_flickr() {
		parent::WP_Widget(false, $name = 'Flickr widget', array('description' => __('Displays your latest Flickr photos.', 'hoffman') ));	
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID (use <a target="_blank" href="http://www.idgettr.com">idGettr</a>):', 'hoffman'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of images to display:', 'hoffman'); ?>
...
register_widget('hoffman_flickr'); ?>