<?php get_header(); ?>
<div class="category-title"><h1> <?php echo single_cat_title(); ?></h1> </div>
<div id="main">
<div id="content">
<?php if(have_posts()) : ?><?php while(have_posts()) : the_post(); ?>
   ...
   <div class="totalcomments"><a href="<?php comments_link(); ?>"><?php comments_number('0', '1', '%'); ?></a><span class="commentname">COMMENTS</span></div>                 <p class="postmetadata">
