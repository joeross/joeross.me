...
= 1.3.1 - June 10 2014 =
* Escape Gravatar email setting.

= 1.3 - June 9 2014 =
* Remove a border from sharedaddy containers.
* Align sharing buttons with text on Image post formats.
* Update Genericons to 3.0.3.

= 1.2.2 - Feb 5 2014 =
* Fix Aside icon to use the appropriate class (.theme-genericon vs. .genericon).

= 1.2.1 - Feb 5 2014 =
* Sanitize Customizer values before saving.
